...
class PositionwiseFeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.layer_norm(pwff_x) + x  # postnorm layer
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, x: Tensor, mask: Tensor) -> Tensor:
        ...
        return self.layer_norm(o)  # postnorm layer
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        h1 = self.x_layer_norm(self.dropout(h1) + x)  # postnorm layer

        # source-target attention
        h2 = self.src_trg_att(memory, memory, h1, mask=src_mask)
        h2 = self.dec_layer_norm(h2)  # postnorm layer

        # final position-wise feed-forward layer
        o = self.feed_forward(self.dropout(h2) + h1)

        return self.dec_layer_norm(o)  # postnorm layer
